...
* Trong template trên, có các thành phần là Parameters, Resources, Outputs.
* Phần Parameters có các thành phần ta lấy được khi cấu hình Parameter Overrides ở Cloudformation deploy stage như BucketName, 3 ObjectKeys của 2 lambda functions, 1 lambda layer.
* Resources thì ta tạo dynamodb table, lambda layer, 2 lambda functions, lambda role thì có quyền với dynamodb và viết log vào cloudwatch, 2 API gateway.
* Outputs thì lấy resources name của 2 lambda functions, layer, dynamodb, 2 api gateways.